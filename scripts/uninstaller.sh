...
case $((STATUS & 3)) in
  ...
  1 )  # Magisk patched
    ...
    BACKUPDIR=/data/joker_backup_$SHA1
    if [ -d $BACKUPDIR ]; then
...
/data/joker.apk /data/busybox /data/custom_ramdisk_patch.sh /data/adb/*magisk* \
/data/adb/post-fs-data.d /data/adb/service.d /data/adb/modules* \
/data/unencrypted/magisk /metadata/joker /persist/magisk /mnt/vendor/persist/magisk

...
1. Set environment variable `ASH_STANDALONE` to `1`<br>Example: `ASH_STANDALONE=1 /data/adb/joker/busybox sh <script>`
2. Toggle with command-line options:<br>`/data/adb/joker/busybox sh -o standalone <script>`
